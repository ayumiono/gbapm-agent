...
import static com.gb.apm.common.trace.AnnotationKeyProperty.*;
...
//    API_ID(11, "API-ID"),
    ...
    AnnotationKey TXC_XID = AnnotationKeyFactory.of(198, "txc.id");//dubbo interceptor和biz interceptor中都有用到，所有放到这里
}