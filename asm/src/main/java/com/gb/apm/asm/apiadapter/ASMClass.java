...
import com.gb.apm.asm.exception.PinpointASMException;
...
import com.gb.apm.asm.objectfactory.AutoBindingObjectFactory;
...
import com.gb.apm.bootstrap.core.interceptor.annotation.TargetConstructor;
import com.gb.apm.bootstrap.core.interceptor.annotation.TargetConstructors;
import com.gb.apm.bootstrap.core.interceptor.annotation.TargetFilter;
import com.gb.apm.bootstrap.core.interceptor.annotation.TargetMethod;
import com.gb.apm.bootstrap.core.interceptor.annotation.TargetMethods;
...
//        }
    ...
    private int addInterceptor0(String interceptorClassName, Object[] constructorArgs, InterceptorScope scope, ExecutionPolicy executionPolicy) throws InstrumentException {
        ...
        if (interceptorId == -1) {
            throw new PinpointASMException("No target is specified. At least one of @Targets, @TargetMethod, @TargetConstructor, @TargetFilter must present. interceptor: " + interceptorClassName);
        }
    ...
    private int addInterceptor0(TargetFilter annotation, String interceptorClassName, InterceptorScope scope, ExecutionPolicy executionPolicy, Object[] constructorArgs) throws InstrumentException {
        ...
        final ArgumentProvider interceptorArgumentProvider = objectBinderFactory.newInterceptorArgumentProvider(this);
